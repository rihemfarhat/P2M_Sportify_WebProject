  ...
  useEffect(() => {
    const fetchWorkouts = async () => {
      try {
        ...
        const filtered = response.data.filter(w => w.Objectif === 'Weight loss and calorie-burning exercises');
  ...
  return (
    <div className="workout-container1">
      <div className="workout-container">
        <h1 className="main-title">Weight Loss Exercises ⚖️</h1>
        <p className="subtitle">Burn calories and get in shape with these workouts</p>
        ...
        <div className="workout-grid">
          {filteredWorkouts.length > 0 ? (
              ...
              >
                ...
                <div className="workout-info">
                  ...
                  <div className="workout-footer">
                    <span className="calories-badge">🔥 {Math.round(workout.duration * 8)} cal</span>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="no-results">
              <p>No weight loss workouts found matching your criteria.</p>
