// src/pages/MuscleWorkouts.js
import React, { useEffect, useState } from 'react';
import axios from 'axios';
import '../style/MobilityWorkouts.css';
  ...
  useEffect(() => {
    const fetchWorkouts = async () => {
      try {
        ...
        const filtered = response.data.filter(w => w.Objectif === 'Muscle-building exercises');
  ...
  return (
    <div className="workout-container1">
      <div className="workout-container">
        <h1 className="main-title">Muscle-building Exercises 💪</h1>
        <p className="subtitle">Build strength with these powerful exercises</p>
        ...
        <div className="workout-grid">
          {filteredWorkouts.length > 0 ? (
              ...
              >
                ...
                <div className="workout-info">
                  ...
                  <div className="workout-footer">
                    <span className="calories-badge">🔥 {Math.round(workout.duration * 7)} cal</span>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="no-results">
              <p>No muscle-building workouts found matching your criteria.</p>
