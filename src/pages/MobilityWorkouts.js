  ...
  useEffect(() => {
    const fetchWorkouts = async () => {
      try {
        ...
        const filtered = response.data.filter(w => w.Objectif === 'Mobility and flexibility exercises');
  ...
  return (
    <div className="workout-container1">
      <div className="workout-container">
        <h1 className="main-title">Mobility & Flexibility 🧘‍♀️</h1>
        <p className="subtitle">Improve your range of motion with these exercises</p>
        ...
        <div className="workout-grid">
          {filteredWorkouts.length > 0 ? (
              ...
              >
                ...
                <div className="workout-info">
                  ...
                  <div className="workout-footer">
                    <span className="calories-badge">🔥 {Math.round(workout.duration * 4)} cal</span>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="no-results">
              <p>No mobility workouts found matching your criteria.</p>
...
export default MobilityWorkouts;