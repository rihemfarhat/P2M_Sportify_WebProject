  ...
  useEffect(() => {
    const fetchWorkouts = async () => {
      try {
        ...
        const filtered = response.data.filter(w => w.Objectif === 'Core strengthening exercises');
  ...
  return (
    <div className="workout-container1">
      <div className="workout-container">
        <h1 className="main-title">Core Strengthening 🦵</h1>
        <p className="subtitle">Strengthen your core with these powerful exercises</p>
        ...
        <div className="workout-grid">
          {filteredWorkouts.length > 0 ? (
              ...
              >
                ...
                <div className="workout-info">
                  ...
                  <div className="workout-footer">
                    <span className="calories-badge">🔥 {Math.round(workout.duration * 6)} cal</span>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="no-results">
              <p>No core workouts found matching your criteria.</p>
